...
public class ItemStatisticByBookingCountQueryValidator : AbstractValidator<ItemStatisticByBookingCountQuery>
{
    public ItemStatisticByBookingCountQueryValidator()
    {
